package edu.ucsb.cs56.drawings.omercohen.simple;
...
/**
   ...
   @author Omer Cohen (fixed the snowmans's head)
...
{  
	...
	Circle snowManTopCircle =
            new Circle
            (
             snowManCenterBottomX, snowManCenterBottomY -bottomRadius*2 - middleRadius*2 - topRadius,
             topRadius
             );
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Added snowman head, Omer Cohen", 20,20);

package edu.ucsb.cs56.drawings.guanguangua.simple;
...
/**
   ...
   @author Guancheng Ren (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Gives the snowman a head :) Guancheng Ren", 20,20);
